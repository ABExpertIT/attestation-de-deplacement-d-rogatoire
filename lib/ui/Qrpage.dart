...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Sortie s = Sortie(widget.name, widget.bday, widget.bplace, widget.adresse,
        widget.reason, widget.date, widget.time);
      ...
      body: Material(
        ...
        child: SafeArea(
          ...
          child: Container(
            child: Column(
              children: <Widget>[
                Padding(padding: EdgeInsets.only(top: 15.0), child: Text('')),
                Container(
